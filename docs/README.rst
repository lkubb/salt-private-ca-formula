...
This will always include base and, if ``pca:ca:minion_id`` matches the minion, also include CA.

``pca.base``
^^^^^^^^^^^^^^^

This will ensure Salt can manage certificates.

``pca.ca``
^^^^^^^^^^^^^

This will create a CA on a minion.
...
References
----------
* https://backbeat.tech/blog/using-saltstack-for-internal-ssl-certificates
* https://docs.saltproject.io/en/latest/ref/states/all/salt.states.x509.html
